...
1. [🧩 Zybo Z7-20 기반 인공지능 통합 교육 커리큘럼 (6주 완성형)](#-zybo-z7-20-기반-인공지능-통합-교육-커리큘럼-6주-완성형)
   - [목표](#목표-fpga--ai--임베디드-리눅스--hls--영상처리-전-과정을-실제-보드-하나로-학습)

2. [📘 1주차 — Zynq SoC 구조 및 Vivado 기초](#-1-주차--zynq-soc-구조-및-vivado-기초)
   - [1주차 목표](#1주차-목표)
   - [준비물](#준비물)
   - [0. 하드웨어 점검 (5분)](#0-하드웨어-점검-5분)
   - [1. Vivado 프로젝트 & 보드 파일 적용 (10분)](#1-vivado-프로젝트--보드-파일-적용-10분)
   - [2. 블록 디자인: Zynq PS + AXI GPIO + Reset (20분)](#2-블록-디자인-zynq-ps--axi-gpio--reset-20분)
   - [3. 제약(XDC)으로 LED 핀 매핑 (10분)](#3-제약xdc으로-led-핀-매핑-10분)
   - [4. Synthesis/Implementation/Bitstream & XSA 내보내기 (10~20분)](#4-synthesisimplementationbitstream--xsa-내보내기-1020분)
   - [5. Vitis(Bare-metal)에서 LED 토글 앱 (20분)](#5-vitisbare-metal에서-led-토글-앱-20분)
   - [6. 검증 체크리스트](#6-검증-체크리스트)
   - [7. 흔한 이슈 & 해결](#7-흔한-이슈--해결)
   - [8. 1주차 산출물](#8-1주차-산출물당신이-보드에서-직접-만들-것)
   - [9. 다음 주(2주차) 예고](#9-다음-주2주차-예고)
